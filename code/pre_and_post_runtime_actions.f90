...
implicit none
    ...
    implicit none
        ...
        !E(1)=0.705764375424274d0
        !nu(1)=0.341504652664807d0
        
        !E(1)=0.636365788744810d0
        !nu(1)=0.222128593068961d0
        !E(1)=0.708478596963202d0
        !nu(1)=0.255132303408228d0
